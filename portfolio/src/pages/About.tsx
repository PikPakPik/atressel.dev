        ...
        <>
            <div id="about" className="container mx-auto lg:px-32 my-[10rem] md:my-25 flex flex-col gap-12">
                ...
                <div className="mt-10 justify-items-center sm:px-0 px-10 dark:text-white text-[#282C33]">
                    ...
                    <br />
                    <br />
                    Vivamus mattis, lectus quis condimentum feugiat, metus mi lacinia purus, rhoncus mollis arcu ligula vel diam. Duis vel interdum purus. Sed sagittis eleifend odio at scelerisque. Cras quam purus, vestibulum in nisl nec, feugiat pellentesque lectus. Donec ac tristique quam. Morbi blandit bibendum vestibulum. Fusce erat justo, tempor vitae ligula vitae, dapibus molestie mi. Etiam facilisis sed quam nec viverra. Integer dictum sodales mi, eu aliquet elit interdum vehicula. Praesent eros nulla, ornare tempus arcu a, aliquam pretium justo. Aenean commodo ante cursus augue porta consectetur. Vivamus consequat ligula feugiat placerat eleifend. Duis iaculis blandit massa, id hendrerit mi tempor sed. Pellentesque tempor suscipit velit, nec hendrerit ipsum.
                    <br />
                    <br />
                    Phasellus vulputate, libero vitae dapibus pulvinar, ante diam posuere est, ac aliquam tellus nibh vitae turpis. Suspendisse felis ipsum, varius tempor venenatis non, laoreet a erat. Nullam rutrum est magna, sed faucibus risus elementum et. Aliquam vel ante ultricies, convallis nulla et, imperdiet tellus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Nullam et libero non nunc scelerisque porta. Sed dictum purus eu magna ultricies, at placerat tortor iaculis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.
                </div>
