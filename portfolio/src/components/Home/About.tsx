        ...
        <div id="about" className="container mx-auto lg:px-32">
            ...
            <div className="flex flex-col lg:flex-row mt-10 px-10 md:px-0">
                <div className="w-full lg:w-1/2 text-gray-400">
                    ...
                    <button className="border-[#C778DD] border-2 text-white font-semibold px-4 py-2 mt-4 w-fit hover:bg-[#C778DD] hover:text-black transition duration-300 ease-in-out">En savoir plus -&gt;</button>
                </div>
