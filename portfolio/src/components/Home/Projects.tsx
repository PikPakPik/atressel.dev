...
const Projects: React.FC<ProjectsProps> = ({ projects }) => {
    ...
    return (
        <div id="projects" className="container mx-auto lg:px-20    ">
            <div className="flex flex-col gap-7 md:gap-0     md:flex-row items-center justify-center md:justify-start">
                ...
                <a href="projects" className="text-white font-semibold md:ml-auto ml-0 hover:text-[#C778DD] transition duration-300 ease-in-out">{t("home.projects.show_more")} ~~&gt;</a>
            </div>
